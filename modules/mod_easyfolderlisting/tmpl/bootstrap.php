...
<table class="table <?php echo $params->get('moduleclass_sfx');?>" style="width:100%; text-align:left;">
	<tr>
		<th style="padding:4px;"><?php echo JText::_('MOD_EFL_FILENAME');?></th>
		<?php if ($params->get('efl_size') == true) : ?>
		<th style="padding:4px;"><?php echo JText::_('MOD_EFL_SIZE');?></th>
		<?php endif; ?>
		<?php if ($params->get('efl_date') == true) : ?>
		<th style="padding:4px;"><?php echo (($params->get('efl_time') == true) ? JText::_('MOD_EFL_DATETIME') : JText::_('MOD_EFL_DATE')); ?></th>
		<?php endif; ?>
	</tr>
	...
	<tr>
		...
		if ($params->get('efl_linktofiles') == true)
		{
			...
			echo '<a '.$target.' href="'.JURI::base().$folder.'/'.$fixedName.'.'.$rows[$i]['ext'].'">';
		}
